...
class AdminClosure extends AdminComponent
{
    use WithFileUploads;
    ...
    public function addProduct(){
        ...
        $this->validate();
        $cat = Category::where('name', 'Closure Hair')->first()->id;
        $product = new Product();
    ...
    public function render()
    {
        ...
        $products = Product::search($this->searchTerm, $cat)
            ...
            ->paginate(5);
        return view('livewire.admin.product.products.closure.admin-closure', [
            'colors' => $colors,
            'Patterns' => $Patterns,
            'products' => $products,
            'lenghts' => $lenghts,
