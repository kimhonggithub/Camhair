...
namespace App\Http\Livewire\Frontend\Shop\CustomizeOrder;
...
class CustomizeOrderComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.shop.customizeorder.customize-order-component',['products'=>$products,'categories'=>$categories,'slider'=>$slider])->layout('layouts.base');
    }
