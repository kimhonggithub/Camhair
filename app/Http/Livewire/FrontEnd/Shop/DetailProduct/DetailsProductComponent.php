...
class DetailsProductComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.shop.detailproduct.details-product-component',['detailsProduct'=>$details_product,'similer_product'=>$similer_product,'allcomment' => $allComment])->layout('layouts.base');
    }
}
