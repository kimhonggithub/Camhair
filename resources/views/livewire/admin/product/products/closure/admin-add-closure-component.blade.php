...
<div class="container">
  <div class="row">
    ...
    <div class="col">
<form wire:submit.prevent="addClosure">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputsize" aria-describedby="emailHelp" placeholder="Size" wire:model="size">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <select class="form-select" wire:model="wig_cap_id">
