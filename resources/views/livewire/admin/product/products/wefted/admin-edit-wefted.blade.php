<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Wefted</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.products')}}">Products</a></li>
                        <li class="breadcrumb-item "><a href="{{route('admin.wefted')}}">Wfted Hair</a></li>
                        <li class="breadcrumb-item active">Edit Wfted Hair</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <form wire:submit.prevent="updateproduct" class="row g-3 p-2">
                    <div class="row">
                        ...
                        <div class="pl-3 justify-content-md-end">
                            ...
                            <a type="button" href="{{route('admin.wefted')}}" class="btn btn-secondary me-md-2"
