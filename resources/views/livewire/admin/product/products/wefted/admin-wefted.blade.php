<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Wefted hair</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/admin/products">Product</a></li>
                        <li class="breadcrumb-item active">Wefted Hair</li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between mb-2">
                        <button wire:click.prevent="addNew" class="btn btn-primary"><i class="fa fa-plus-circle mr-1"></i> Add New Wefted Hair</button>
                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Luster
                                            <span wire:click="sortBy('Luster')" class="float-right text-sm" style="cursor: pointer;">
                                                <i class="fa fa-arrow-up {{ $sortColumnName === 'Luster' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                                <i class="fa fa-arrow-down {{ $sortColumnName === 'Luster' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                            </span>
                                        </th>
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <img src="{{asset('image')}}/{{$product->product_thumbnail}}" alt="" width="60" height="60">
                                        </th>
                                        <th>
                                            <?php
                                            ...
                                            <img src="{{ asset('image/all') }}/{{ $pimage->image_name}}" alt="" width="50" height="50">
                                            @endforeach
                                        </th>
                                        <td>{{ $product->name }}</td>
                                        ...
                                        <td>
                                            <a href="{{route('admin.editwefted',['product_slug' => $product->slug])}}">
                            ...
                            <div class="row">
                                <div class="col-lg-8 border-right">
                                    <div class="form-row ">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control @error('category_id') is-invalid @enderror " wire:model="category_id" disabled>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('reguler_price') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Reguler Price" wire:model="reguler_price">
                                            @error('regular_price')
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('discount') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Discount" wire:model="discount">
                                            @error('discount')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea cols="60" rows="4" class="form-control @error ('description') is-invalid @enderror" id="exampleFormControlTextarea1" placeholder="Description" wire:model="description"></textarea>
                                            @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control @error ('SKU') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="SKU" wire:model="SKU">
                                            @error('SKU')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control @error ('quantity')  is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Quantity" wire:model="quantity">
                                            @error('quantity')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select class="form-control form-control @error('lenghts_id') is-invalid @enderror" wire:model="lenghts_id">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select class="form-control form-control @error('color_id') is-invalid @enderror" wire:model="color_id">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select class="form-control @error('pattern_id') is-invalid @enderror " wire:model="pattern_id">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-row">
                                        ...
                                        <div class="custom-file">
                                            <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false; progress = 5" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                                                <input wire:model="product_thumbnail" type="file" class="custom-file-input " id="customFile">
                                            ...
                                            <label class="custom-file-label @error ('product_thumbnail') is-invalid @enderror" for="customFile">
                                        ...
                                        @if ($product_thumbnail)
                                        <img src="{{ $product_thumbnail->temporaryUrl()}}" class="img d-block mt-2 w-50 rounded">
                                     @endif
                                    </div>
                                    <br>
                                    <hr>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="custom-file">
                                            <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false; progress = 5" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                                                <input wire:model="images" type="file" class="form-control" id="customFile" multiple>
                                                <div x-show.transition="isUploading" class="progress progress-sm mt-2 rounded">
                                                    <div class="progress-bar bg-primary progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" x-bind:style="`width: ${progress}%`">
                                                        <span class="sr-only">40% Complete (success)</span>
                                                    </div>
